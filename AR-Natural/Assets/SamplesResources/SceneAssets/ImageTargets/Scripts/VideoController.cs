...
public class VideoController : MonoBehaviour
{
    ...
    public Button g_PlayButton; // 게임 플레이 버튼
    public Text mapName; // 맵이름 저장해 둘 text
    ...
    void Update()
    {
        ...
        if (videoPlayer.isPlaying)
        {
            ...
            mapName.text = videoPlayer.clip.name; // 이름 저장
            g_PlayButton.interactable = true; // 영상 플레이시 버튼 활성화
